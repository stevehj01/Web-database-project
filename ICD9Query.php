...
?>
            ...
            <div class="container2">
                <h2>Query for ICD9</h2>
                    <form name="icd9" action="resultICD9.php"  id = "icd9" method="post">
                    		ICD9 Code: <input type="text" name="icd9ID" id="icd9ID" /> 
                    		ICD9 Description: <input type="text" name="icd9Desc" id="icd9Desc" />
                            <input type="submit"  value ="Enter ICD9 Data" name ="input"</>
                    </form>
