...
?>
            ...
            <div class="container">
                <h2>Enter Provider Data</h2>
                    <form name="provider" action="providerInput.php"  id = "provider" method="post">
                            First Name: <input type="text" name="firstName" id="fname" />
                            Last Name: <input type="text" name="lastName" id="lname" /> 
                            <input type="submit"  value ="Enter Provider Data" name ="input" style="font-family: sans-serif; font-size: 14px;"></>
                    </select>         
                    </form>
