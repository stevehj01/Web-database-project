...
?>
            ...
            <div class="container">
                <h2>Enter Test Results Data</h2>
                    <form name="test" action="testInput.php"  id = "test" method="post">
                            VisitID: <input type="text" name="visitID" id="visit" />
                            Test File name: <input type="text" name="fileName" id="file" /> 
                            <br>
