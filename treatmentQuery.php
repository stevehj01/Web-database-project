...
?>
            ...
            <div class="container2">
                <h2>Query for Treatment</h2>
                    <form name="treat" action="resultTreatment.php"  id = "treat" method="post">
                    		Treatment ID: <input type="text" name="treatID" id="treatID" /> 
                    		Treatment Description: <input type="text" name="treatDesc" id="treatDesc" />
