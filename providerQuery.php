...
?>
            ...
            <div class="container2">
                <h2>Query for Provider</h2>
                    <form name="provider" action="resultProvider.php"  id = "provider" method="post">
                    		Provider ID: <input type="text" name="providerID" id="providerID" /> 
                    		Provider First Name: <input type="text" name="firstName" id="firstName" />
                    		Provider Last Name: <input type="text" name="lastName" id="lastName" />
                            <input type="submit"  value ="Enter Provider Data" name ="input"</>
                    </form>
