...
?>
            ...
            <div class="container2">
                <h2>Query for System</h2>
                    <form name="sys" action="resultSystem.php"  id = "sys" method="post">
                    		System ID: <input type="text" name="sysID" id="sysID" /> 
                    		System Description: <input type="text" name="sysDesc" id="sysDesc" />
                            <input type="submit"  value ="Enter System Data" name ="input"</>
                    </form>
