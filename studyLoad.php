...
?>
            ...
            <div class="container">
                <h2>Enter Study Data</h2>
                    <form name="study" action="inputStudy.php"  id = "study" method="post">
                            Study ID: <input type="text" name="studyID" id="studyID"/> 
                            Description: <input type="text" name="description" id="description" /> 
                            IRB Number: <input type="text" name="irbNum" id="irbNum"/><br>   
                            Condition: <select name="condition" form="study">
